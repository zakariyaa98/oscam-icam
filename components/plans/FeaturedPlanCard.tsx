  ...
  return (
    <div
      className={`relative flex h-full flex-col gap-7 rounded-3xl border bg-white p-8 shadow-[0_4px_24px_rgba(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_12px_40px_rgba(0,0,0,0.14)] sm:p-9 ${
        ...
        // same green family, tuned dark enough to read clearly against white.
        plan.featured
    ...
    >
      {plan.badge ? (
        <span className="absolute left-1/2 top-0 z-10 w-max max-w-[88%] -translate-x-1/2 -translate-y-1/2 whitespace-normal text-balance rounded-full bg-aqua px-3.5 py-1.5 text-center text-[10px] font-bold uppercase leading-tight tracking-wide text-black shadow-[0_4px_16px_rgba(75,235,30,0.4)] sm:px-4 sm:text-xs">
          {plan.badge}
        </span>
      ) : null}
      ...
      <div className="flex flex-col items-center gap-1 text-center">
        ...
        <p className="text-xs uppercase tracking-widest text-[#6b7280]">ab</p>
